...
var (
	...
	errConnTimeout      = errors.New("connect to a2 daemon timeout")
)
...
// `a2.addUri([secret, ]uris[, options[, position]])`
// This method adds a new download. uris is an array of HTTP/FTP/SFTP/BitTorrent URIs (strings) pointing to the same resource.
// If you mix URIs pointing to different resources, then the download may fail or be corrupted without a2 complaining.
...
func (c *client) AddURI(uri string, options ...interface{}) (gid string, err error) {
	...
	err = c.Call(a2AddURI, params, &gid)
	return
}

// `a2.addTorrent([secret, ]torrent[, uris[, options[, position]]])`
// This method adds a BitTorrent download by uploading a ".torrent" file.
// If you want to add a BitTorrent Magnet URI, use the a2.addUri() method instead.
...
func (c *client) AddTorrent(filename string, options ...interface{}) (gid string, err error) {
	...
	err = c.Call(a2AddTorrent, params, &gid)
	return
}

// `a2.addMetalink([secret, ]metalink[, options[, position]])`
...
func (c *client) AddMetalink(filename string, options ...interface{}) (gid []string, err error) {
	...
	err = c.Call(a2AddMetalink, params, &gid)
	return
}

// `a2.remove([secret, ]gid)`
...
func (c *client) Remove(gid string) (g string, err error) {
	...
	err = c.Call(a2Remove, params, &g)
	return
}

// `a2.forceRemove([secret, ]gid)`
// This method removes the download denoted by gid.
// This method behaves just like a2.remove() except that this method removes the download without performing any actions which take time, such as contacting BitTorrent trackers to unregister the download first.
func (c *client) ForceRemove(gid string) (g string, err error) {
	...
	params = append(params, gid)
	err = c.Call(a2ForceRemove, params, &g)
	return
}
...
// To change status to waiting, use the a2.unpause() method.
...
func (c *client) Pause(gid string) (g string, err error) {
	...
	params = append(params, gid)
	err = c.Call(a2Pause, params, &g)
	return
}

// `a2.pauseAll([secret])`
// This method is equal to calling a2.pause() for every active/waiting download.
...
func (c *client) PauseAll() (ok string, err error) {
	...
	err = c.Call(a2PauseAll, params, &ok)
	return
}

// `a2.forcePause([secret, ]gid)`
// This method pauses the download denoted by gid.
// This method behaves just like a2.pause() except that this method pauses downloads without performing any actions which take time, such as contacting BitTorrent trackers to unregister the download first.
func (c *client) ForcePause(gid string) (g string, err error) {
	...
	params = append(params, gid)
	err = c.Call(a2ForcePause, params, &g)
	return
}

// `a2.forcePauseAll([secret])`
// This method is equal to calling a2.forcePause() for every active/waiting download.
// This methods returns OK.
func (c *client) ForcePauseAll() (ok string, err error) {
	...
	err = c.Call(a2ForcePauseAll, params, &ok)
	return
}

// `a2.unpause([secret, ]gid)`
...
func (c *client) Unpause(gid string) (g string, err error) {
	...
	params = append(params, gid)
	err = c.Call(a2Unpause, params, &g)
	return
}

// `a2.unpauseAll([secret])`
// This method is equal to calling a2.unpause() for every active/waiting download.
// This methods returns OK.
func (c *client) UnpauseAll() (ok string, err error) {
	...
	err = c.Call(a2UnpauseAll, params, &ok)
	return
}

// `a2.tellStatus([secret, ]gid[, keys])`
...
// For example, a2.tellStatus("2089b05ecca3d829", ["gid", "status"]) returns the gid and status keys only.
// The response is a struct and contains following keys. Values are strings.
// https://a2.github.io/manual/en/html/a2c.html#a2.tellStatus
func (c *client) TellStatus(gid string, keys ...string) (info StatusInfo, err error) {
	...
	err = c.Call(a2TellStatus, params, &info)
	return
}

// `a2.getUris([secret, ]gid)`
...
func (c *client) GetURIs(gid string) (infos []URIInfo, err error) {
	...
	params = append(params, gid)
	err = c.Call(a2GetURIs, params, &infos)
	return
}

// `a2.getFiles([secret, ]gid)`
...
// https://a2.github.io/manual/en/html/a2c.html#a2.getFiles
func (c *client) GetFiles(gid string) (infos []FileInfo, err error) {
	...
	params = append(params, gid)
	err = c.Call(a2GetFiles, params, &infos)
	return
}

// `a2.getPeers([secret, ]gid)`
...
// https://a2.github.io/manual/en/html/a2c.html#a2.getPeers
func (c *client) GetPeers(gid string) (infos []PeerInfo, err error) {
	...
	params = append(params, gid)
	err = c.Call(a2GetPeers, params, &infos)
	return
}

// `a2.getServers([secret, ]gid)`
// This method returns currently connected HTTP(S)/FTP/SFTP servers of the download denoted by gid (string).
// The response is an array of structs and contains the following keys. Values are strings.
// https://a2.github.io/manual/en/html/a2c.html#a2.getServers
func (c *client) GetServers(gid string) (infos []ServerInfo, err error) {
	...
	params = append(params, gid)
	err = c.Call(a2GetServers, params, &infos)
	return
}

// `a2.tellActive([secret][, keys])`
// This method returns a list of active downloads.
// The response is an array of the same structs as returned by the a2.tellStatus() method.
// For the keys parameter, please refer to the a2.tellStatus() method.
func (c *client) TellActive(keys ...string) (infos []StatusInfo, err error) {
	...
	err = c.Call(a2TellActive, params, &infos)
	return
}

// `a2.tellWaiting([secret, ]offset, num[, keys])`
...
// a2.tellWaiting(0, 1) returns ["A"].
// a2.tellWaiting(1, 2) returns ["B", "C"].
// a2.tellWaiting(-1, 2) returns ["C", "B"].
// The response is an array of the same structs as returned by a2.tellStatus() method.
func (c *client) TellWaiting(offset, num int, keys ...string) (infos []StatusInfo, err error) {
	...
	err = c.Call(a2TellWaiting, params, &infos)
	return
}

// `a2.tellStopped([secret, ]offset, num[, keys])`
...
// num is an integer and specifies the max. number of downloads to be returned.
// For the keys parameter, please refer to the a2.tellStatus() method.
// offset and num have the same semantics as described in the a2.tellWaiting() method.
// The response is an array of the same structs as returned by the a2.tellStatus() method.
func (c *client) TellStopped(offset, num int, keys ...string) (infos []StatusInfo, err error) {
	...
	err = c.Call(a2TellStopped, params, &infos)
	return
}

// `a2.changePosition([secret, ]gid, pos, how)`
...
// For example, if GID#2089b05ecca3d829 is currently in position 3, a2.changePosition('2089b05ecca3d829', -1, 'POS_CUR') will change its position to 2. Additionally a2.changePosition('2089b05ecca3d829', 0, 'POS_SET') will change its position to 0 (the beginning of the queue).
func (c *client) ChangePosition(gid string, pos int, how string) (p int, err error) {
	...
	err = c.Call(a2ChangePosition, params, &p)
	return
}

// `a2.changeUri([secret, ]gid, fileIndex, delUris, addUris[, position])`
...
// In other words, if there are three URIs http://example.org/a2 and you want remove them all, you have to specify (at least) 3 http://example.org/a2 in delUris.
...
func (c *client) ChangeURI(gid string, fileindex int, delUris []string, addUris []string, position ...int) (p []int, err error) {
	...
	err = c.Call(a2ChangeURI, params, &p)
	return
}

// `a2.getOption([secret, ]gid)`
...
func (c *client) GetOption(gid string) (m Option, err error) {
	...
	params = append(params, gid)
	err = c.Call(a2GetOption, params, &m)
	return
}

// `a2.changeOption([secret, ]gid, options)`
...
func (c *client) ChangeOption(gid string, option Option) (ok string, err error) {
	...
	err = c.Call(a2ChangeOption, params, &ok)
	return
}

// `a2.getGlobalOption([secret])`
// This method returns the global options.
// The response is a struct.
// Its keys are the names of options.
// Values are strings.
// Note that this method does not return options which have no default value and have not been set on the command-line, in configuration files or RPC methods. Because global options are used as a template for the options of newly added downloads, the response contains keys returned by the a2.getOption() method.
func (c *client) GetGlobalOption() (m Option, err error) {
	params := []string{}
	if c.token != "" {
		params = append(params, "token:"+c.token)
	}
	err = c.Call(a2GetGlobalOption, params, &m)
	return
}

// `a2.changeGlobalOption([secret, ]options)`
...
func (c *client) ChangeGlobalOption(options Option) (ok string, err error) {
	...
	params = append(params, options)
	err = c.Call(a2ChangeGlobalOption, params, &ok)
	return
}

// `a2.getGlobalStat([secret])`
...
func (c *client) GetGlobalStat() (info GlobalStatInfo, err error) {
	...
	err = c.Call(a2GetGlobalStat, params, &info)
	return
}

// `a2.purgeDownloadResult([secret])`
...
func (c *client) PurgeDownloadResult() (ok string, err error) {
	...
	err = c.Call(a2PurgeDownloadResult, params, &ok)
	return
}

// `a2.removeDownloadResult([secret, ]gid)`
...
func (c *client) RemoveDownloadResult(gid string) (ok string, err error) {
	...
	params = append(params, gid)
	err = c.Call(a2RemoveDownloadResult, params, &ok)
	return
}

// `a2.getVersion([secret])`
// This method returns the version of a2 and the list of enabled features.
// The response is a struct and contains following keys.
//
//	version            Version number of a2 as a string.
...
func (c *client) GetVersion() (info VersionInfo, err error) {
	...
	err = c.Call(a2GetVersion, params, &info)
	return
}

// `a2.getSessionInfo([secret])`
// This method returns session information.
// The response is a struct and contains following key.
//
//	sessionId    Session ID, which is generated each time when a2 is invoked.
func (c *client) GetSessionInfo() (info SessionInfo, err error) {
	params := []string{}
	if c.token != "" {
		params = append(params, "token:"+c.token)
	}
	err = c.Call(a2GetSessionInfo, params, &info)
	return
}

// `a2.shutdown([secret])`
// This method shutdowns a2.
// This method returns OK.
func (c *client) Shutdown() (ok string, err error) {
	...
	err = c.Call(a2Shutdown, params, &ok)
	return
}

// `a2.forceShutdown([secret])`
// This method shuts down a2().
// This method behaves like :func:'a2.shutdown` without performing any actions which take time, such as contacting BitTorrent trackers to unregister downloads first.
// This method returns OK.
func (c *client) ForceShutdown() (ok string, err error) {
	...
	err = c.Call(a2ForceShutdown, params, &ok)
	return
}

// `a2.saveSession([secret])`
...
func (c *client) SaveSession() (ok string, err error) {
	...
	err = c.Call(a2SaveSession, params, &ok)
	return
}
...
func (c *client) Multicall(methods []Method) (r []interface{}, err error) {
	...
	err = c.Call(a2Multicall, methods, &r)
	return
}
...
func (c *client) ListMethods() (methods []string, err error) {
	err = c.Call(a2ListMethods, []string{}, &methods)
	return
}
